    ...
    public sealed partial class CardForm : Form
    {
        ...
        private void ToggleTheme()
        {
            ...
            if (_isDarkMode)
            {
                ...
                if (_host.Controls.Count > 0 && _host.Controls[0] is FlashcardsFeatureControl flashcardsViewDark)
                {
                    flashcardsViewDark.SetDarkMode(true);
                }
            }
            else
            {
                ...
                if (_host.Controls.Count > 0 && _host.Controls[0] is FlashcardsFeatureControl flashcardsViewLight)
                {
                    flashcardsViewLight.SetDarkMode(false);
                }
            }
